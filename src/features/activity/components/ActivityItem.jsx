...
const ActivityItem = ({ activity }) => {
  ...
  return (
    <div className="group flex items-start gap-4 px-5 py-4 hover:bg-gray-50/70 dark:hover:bg-gray-800/50 transition-colors duration-150">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-snug">
          ...
          {taskTitle && (
            <> <span className="text-gray-400">·</span>{" "}
              <span className="font-medium text-gray-800 dark:text-gray-200">"{taskTitle}"</span>
            </>
          )}
          {teamName && !taskTitle && (
            <> <span className="text-gray-400">·</span>{" "}
              <span className="font-medium text-gray-800 dark:text-gray-200">{teamName}</span>
            </>
          )}
        </p>
        ...
        <div className="flex items-center gap-2 mt-1 flex-wrap">
          ...
          <span className="hidden sm:inline text-gray-300 dark:text-gray-600 text-[10px]">·</span>
